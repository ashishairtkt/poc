...
export const NavAccountMenu = ({
    ...
    onSignOut,
    ...dialogProps
}: AriaDialogProps & { className?: string; user?: User; onSignOut?: () => void }) => {
                ...
                {/* <div className="flex flex-col gap-0.5 border-t border-secondary py-1.5">
                    ...
                    <div className="flex flex-col gap-0.5 px-1.5">
                        {placeholderAccounts.map((account) => (
                            ...
                            >
                                <AvatarLabelGroup status="online" size="md" src={user?.avatar || ""} title={user?.fullName || "User"} subtitle={user?.email || ""} />
