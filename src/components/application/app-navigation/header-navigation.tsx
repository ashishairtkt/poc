...
import { NavAccountCard, NavAccountMenu, type User } from "./base-components/nav-account-card";
...
interface HeaderNavigationBaseProps {
    ...
    hideBorder?: boolean;
    /** Callback fired when the user clicks "Sign out" in the account menu. */
    onSignOut?: () => void;
    /** Logged in user data. */
    user?: User;
}
            ...
            <MobileNavigationHeader>
                <aside className="flex h-full max-w-full flex-col justify-between overflow-auto border-r border-secondary bg-primary pt-4 lg:pt-6">
                    ...
                    <div className="mt-auto flex flex-col gap-4 px-2 py-4 lg:px-4 lg:py-6">
                        ...
                        <NavAccountCard user={user} onSignOut={onSignOut} />
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {showAvatarDropdown && (
                                <DialogTrigger>
                                    ...
                                    >
                                        <Avatar alt={user?.fullName || "User"} src={user?.avatar || "https://www.untitledui.com/images/avatars/olivia-rhye?bg=%23E0E0E0"} size="md" />
                                    ...
                                    >
                                        <NavAccountMenu user={user} onSignOut={onSignOut} />
